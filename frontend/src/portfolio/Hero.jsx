...
import { FaGithub, FaLinkedin, FaReact, FaNodeJs, FaTwitter } from 'react-icons/fa';
import { DiJavascript, DiMongodb } from 'react-icons/di';
import { RiCustomerService2Fill, RiGraduationCapFill, RiMoneyDollarCircleFill } from 'react-icons/ri';
import {SiGeeksforgeeks, SiGithub, SiGmail, SiLeetcode, SiLinkedin, SiMediamarkt, SiTailwindcss} from "react-icons/si"
...
const Hero = ({data}) => {
  console.log(data);
  const sequence = data.basicProfile.titles.flatMap(item => [item, 1000]);
  const platformIcons = {
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden py-16 lg:py-24">
      ...
      <div className="container mx-auto px-4 lg:px-6 z-10">
        ...
        <motion.a
          ...
          href={username}
          title={platform}
          target={platform === "Email" ? "_self" : "_blank"} // Open email in the same tab, others in new tab
